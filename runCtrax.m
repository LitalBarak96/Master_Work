...
answer_change = questdlg('analyse avi of ufmf?', ...
	'ufmf or avi', ...
	'ufmf','avi','avi');
% Handle response
switch answer_change
    case 'ufmf'
        disp([answer_change ' you choose ufmf '])
        change = 1;
    case 'avi'
        disp([answer_change ' you choose avi '])
        change = 2;
end
...
if(change == 2)
    ...
    handles = struct();
namesFile = fullfile(fileparts(which('runAll')),'filesNamesufmf.mat');
if exist(namesFile, 'file') == 2
    load(namesFile);
    handles.fixedFileName = fixedFileName;
    handles.fixedParametersFileName = fixedParametersFileName;
    ...
    handles.fixedParametersFileName = 'movie_fix_parameters.mat';
    handles.trackingFileName = 'movie.mat';
    handles.movieFileName = 'movie.ufmf';
    handles.jaabaFileName = 'registered_trx.mat';
    handles.perframeDirName = 'perframe';
    handles.annFileName = 'movie.ufmf.ann';
end
