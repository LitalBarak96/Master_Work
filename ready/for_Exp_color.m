...
prompt = {'insert height window size','insert width window size','insert font size','insert asterisk size','wish to delete the paramters file?(1-yes,0-no if no please remmber delete manually)','run only visual(1)?or run from the begining'};
dlgtitle = 'Input';
dims = [1 35];
