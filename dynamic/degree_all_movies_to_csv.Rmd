...
list_of_all_groups<-list.dirs(path = "D:/Elia/cyp6a20", full.names = TRUE, recursive = FALSE)
number_of_dirs<-round(length(list.dirs(recursive = T,path = "D:/Elia/cyp6a20"))/2)
