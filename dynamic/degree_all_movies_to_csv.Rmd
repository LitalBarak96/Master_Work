...
list_of_all_groups<-list.dirs(path = "D:/EX5_6", full.names = TRUE, recursive = FALSE)
Number_of_groups<-length(list_of_all_groups)
number_of_dirs<-round(length(list.dirs(recursive = T,path = "D:/EX5_6"))/2)
...
path_to_scripts<-"C:/Users/lital/OneDrive - Bar Ilan University/Lital/code/interactions_network/dynamic/sub_scripts"
