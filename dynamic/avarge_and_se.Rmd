...
```{r}
group.colors <- c("#3D1A39", "#CC6600", "#9633FF",  "#E2FF33",  "#E3DB71","#E3DB71")
...
geom_point() +
geom_line() +
geom_ribbon(aes(ymin=Mean-se, ymax=Mean+se), alpha=0.5, linetype=0) +facet_wrap(~ group)+
...
component_plot <- ggplot(data=all_condtion_se_and_mean, aes(y=Mean, x=frame, group=group, colour=group,
                      fill=group)) +scale_colour_manual(values = c("Females_Mated"="red", "Females_Grouped"="darkmagenta", "Females_Singles"="deeppink1", "Males_Grouped"="orange","Males_Mated"="dodgerblue3","Males_Singels"="chartreuse4")) +
geom_point() +
geom_line() +
geom_ribbon(aes(ymin=Mean-se, ymax=Mean+se), alpha=0.5, linetype=0) +scale_fill_manual(values = c("Females_Mated"="red", "Females_Grouped"="darkmagenta", "Females_Singles"="deeppink1", "Males_Grouped"="orange","Males_Mated"="dodgerblue3","Males_Singels"="chartreuse4")) +
