...
geom_point(size=0.5) +
geom_line(size=0.5) +
geom_ribbon(aes(ymin=Mean-se, ymax=Mean+se), alpha=0.15, linetype=0) +scale_colour_manual(values = c("Females_Mated"="#FFCCCC", "Females_Grouped"="#FF6666", "Females_Singles"="#990000", "Males_Grouped"="#3399FF","Males_Mated"="#99CCFF","Males_Singles"="#0000CC"))  +facet_wrap(~ group)+
theme_classic()+ggtitle("density per frame all conditions all movies with se") +
  xlab("frames") + ylab("density") +theme(
plot.title = element_text(color="black", size=13, face="bold.italic"),
axis.title.x = element_text(color="black", size=13, face="bold"),
...
geom_point(size=0.5) +
geom_line(size=0.5) +
geom_ribbon(aes(ymin=Mean-se, ymax=Mean+se), alpha=0.15, linetype=0) +scale_colour_manual(values = c("Females_Mated"="#FFCCCC", "Females_Grouped"="#FF6666", "Females_Singles"="#990000", "Males_Grouped"="#3399FF","Males_Mated"="#99CCFF","Males_Singles"="#0000CC")) +
theme_classic()+ggtitle("density per frame all conditions all movies with se") +
  xlab("frames") + ylab("density") +theme(
plot.title = element_text(color="black", size=13, face="bold.italic"),
axis.title.x = element_text(color="black", size=13, face="bold"),
...
plot(pl)
   ...
   plotname<-paste0("D:/EX5_6/density_diff_colors.tiff")
...
# looks ok, no lines at the edges
   ...
   plotname<-paste0("D:/EX5_6/com_size_diff_colors.tiff")
