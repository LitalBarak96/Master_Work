...
pl <- ggplot(data=all_sd_and_avg_all_conditions_final, aes(y=Mean, x=frame, group=group, colour=group,
                      fill=group)) +scale_colour_manual(values = c("Females_Mated"="#FFCCCC", "Females_Grouped"="#FF6666", "Females_Singles"="#990000", "Males_Grouped"="#3399FF","Males_Mated"="#99CCFF","Males_Singles"="#0000CC")) +
geom_point(size=0.3) +
geom_line(size=0.3) +
geom_ribbon(aes(ymin=Mean-se, ymax=Mean+se), alpha=0.3, linetype=0) +scale_fill_manual(values = c("Females_Mated"="#FFCCCC", "Females_Grouped"="#FF6666", "Females_Singles"="#990000", "Males_Grouped"="#3399FF","Males_Mated"="#99CCFF","Males_Singles"="#0000CC")) +
theme_classic()+ggtitle("density per frame all conditions all movies with se") +
  xlab("frames") + ylab("density") +theme(
plot.title = element_text(color="black", size=13, face="bold.italic"),
axis.title.x = element_text(color="black", size=13, face="bold"),
...
geom_point(size=0.3) +
geom_line(size=0.3) +
geom_ribbon(aes(ymin=Mean-se, ymax=Mean+se), alpha=0.15, linetype=0) +scale_fill_manual(values = c("Females_Mated"="#FFCCCC", "Females_Grouped"="#FF6666", "Females_Singles"="#990000", "Males_Grouped"="#3399FF","Males_Mated"="#99CCFF","Males_Singles"="#0000CC"))  +facet_wrap(~ group)+
theme_classic()+ggtitle("density per frame all conditions all movies with se") +
  xlab("frames") + ylab("density") +theme(
plot.title = element_text(color="black", size=13, face="bold.italic"),
axis.title.x = element_text(color="black", size=13, face="bold"),
...
library(svglite)
   ...
   plotname<-paste0("D:/EX5_6/density_diff_colors.svg")
  
 svglite(file=plotname,height=11,width=11)
...
geom_point(size=0.5) +
geom_line(size=0.5) +
geom_ribbon(aes(ymin=Mean-se, ymax=Mean+se), alpha=0.15, linetype=0) +scale_fill_manual(values = c("Females_Mated"="#FFCCCC", "Females_Grouped"="#FF6666", "Females_Singles"="#990000", "Males_Grouped"="#3399FF","Males_Mated"="#99CCFF","Males_Singles"="#0000CC")) +
theme_classic()+ggtitle("component size(after moving avarge) per frame all conditions all movies with se") +
  xlab("frames") + ylab("component size") +theme(
plot.title = element_text(color="black", size=13, face="bold.italic"),
axis.title.x = element_text(color="black", size=13, face="bold"),
...
# looks ok, no lines at the edges
   ...
   plotname<-paste0("D:/EX5_6/com_size_diff_colors.svg")
