...
geom_point() +
geom_line() +
geom_ribbon(aes(ymin=Mean-se, ymax=Mean+se), alpha=0.5, linetype=0) +scale_fill_manual(values = c("Females_Mated"="red", "Females_Grouped"="darkmagenta", "Females_Singles"="deeppink1", "Males_Grouped"="orange","Males_Mated"="dodgerblue3","Males_Singels"="chartreuse4")) +facet_wrap(~ group)+
