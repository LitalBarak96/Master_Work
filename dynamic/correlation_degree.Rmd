...
library(corrplot)
  ...
  #select significant values  
  temp_degree_corr <- subset(temp_degree_corr, abs(Freq) > 0.4) 
  #sort by highest correlation
...
png(filename = "C:/Users/barakli8/OneDrive - Bar Ilan University/Lital/weekly presentation/16.06/corrplot_female_mated.png", width = 1200, height = 800)
corrplot(mtx_corr, is.corr=FALSE, tl.col="black", na.label=" ",tl.cex = 1)
