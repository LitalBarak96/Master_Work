...
library(openxlsx)
library(R.matlab)
df<-readMat("F:/allGroups/Females_Grouped/Assa_Females_Grouped_Unknown_RigA_20211024T080419/Allinteraction.mat")
...
for(i in 1:(length(numbers)-1)){
  ...
  temp_between_values<-all %>% filter(onset > numbers[i],terminus<numbers[i+1])
