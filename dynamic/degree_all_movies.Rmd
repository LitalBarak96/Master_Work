...
library(igraph)
library(R.matlab)
path ="D:/allGroups/Females_Grouped"
setwd(path)
number_of_flys<-10
number_of_frame<-40
facade<-TRUE
...
axis.title.y = element_text(color="#993333", size=7, face="bold")
 ...
 name_for_file<-paste0(basename(path),number_of_frame,"_frames_all_movies_sum_degree_with_avg_red.pdf")
...
plot(p)
 ...
 name_for_file<-paste0(basename(path),number_of_frame,"_frames_all_movies_sum_degree_each_movie_.pdf")
