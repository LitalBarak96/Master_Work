...
draw_plot_1 <- function(data_input, num_var_1, num_var_2,color_choice){
...
data_input <- reactive({
  ...
  observeEvent(data_input(),{
    ...
    updateSelectInput(inputId = "analysis_type", choices = c("corrleaction","heatmap","component","degree"))
