...
dirs<-paths_of_groups %>%
  filter(str_detect(groupNameDir, "Mated"))
```

## R Markdown
#tsne for female mated and male mated
...
#ggsave(file="male_vs_female_mated.pdf",device="pdf",path="F:/allGroups",units="cm",width=20,height=20,dpi="retina")
