...
dirs<-paths_of_groups %>%
  filter(str_detect(groupNameDir, "Males"))
```
...
#ggsave(file="all_males_tsne.pdf",device="pdf",path="F:/allGroups",units="cm",width=20,height=20,dpi="retina")
