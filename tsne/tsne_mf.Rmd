...
par(cex=1)
legend(x="topleft",legend = names(colors),fill=colors)

ggsave(file="male_Vs_female.pdf",device="pdf",path="F:/allGroups",units="cm",width=20,height=20,dpi="retina")
