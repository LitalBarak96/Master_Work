...
dirs<-paths_of_groups %>%
  filter(str_detect(groupNameDir, "Females"))
```

## R Markdown
#tsne for only females
...
#ggsave(file="all_females_tsne.pdf",device="pdf",path="F:/allGroups",units="cm",width=20,height=20,dpi="retina")
...
```{r all sub groups trying hyper, echo=FALSE}
library(Rtsne)
